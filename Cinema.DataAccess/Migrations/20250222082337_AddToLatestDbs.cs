...
{
    /// <inheritdoc />
    public partial class AddToLatestDbs : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Coupons",
                columns: new[] { "CouponID", "Code", "DiscountPercentage", "ExpireDate", "UsageLimit", "UsedCount" },
                values: new object[] { 1, "TEST10", 10.00m, null, 10m, 1 });
