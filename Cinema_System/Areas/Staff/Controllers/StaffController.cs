...
namespace Cinema_System.Areas.Staff.Controllers
{
    ...
    public class StaffController : Controller
    {
        ...
        public async Task<IActionResult> ValidAuthentication(int OrderID, string Key, long Timestamp)
        {
            ...
            includeProperties: "Product,ShowtimeSeat.Showtime,ShowtimeSeat.Showtime.Room,ShowtimeSeat.Showtime.Room.Theater,ShowtimeSeat.Showtime.Movie,ShowtimeSeat.Seat,Order.Coupon,Order");
